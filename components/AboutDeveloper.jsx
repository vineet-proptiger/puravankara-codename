        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Puravankara Limited, with over 40 years of expertise, is a leader in Indian real estate — known for world-class developments that redefine how people live. Combining innovation, quality, and scale, Puravankara delivers excellence at an unmatched pace. Having delivered over 100 million sq. ft. of space and 65,000+ homes, Puravankara is committed to sustainability and uses cutting-edge design to craft timeless residences that are both luxurious and environmentally conscious.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                ...
                { value: '100 M+', label: 'Sq. Ft. Delivered' },
                { value: '65,000+', label: 'Homes Delivered' },
              ].map((stat, i) => (
                <div key={i} style={{
