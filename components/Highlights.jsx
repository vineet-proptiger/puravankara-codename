...
const highlights = [
  {
    text: 'Luxury 3 & 4 BHK Residences Starting ₹ 2.99 Cr*',
    icon: <BedDouble {...highlightIconProps} />,
  },
  {
    text: 'Prime Location — Hennur Main Road, North Bangalore',
    icon: <MapPin {...highlightIconProps} />,
  },
  {
    text: '80% Open Space — Green & Breathable Living',
    icon: <LayoutPanelLeft {...highlightIconProps} />,
  },
  {
    text: 'Single Tower, Two Independent Wings — Privacy, Circulation & Exclusivity On Every Floor',
    icon: <Building2 {...highlightIconProps} />,
  },
  {
    text: 'All Apartments Offer A 270 Degree Open View With Luxury Specifications',
    icon: <TrendingUp {...highlightIconProps} />,
  },
  {
    text: 'Every Residence Opens To 2 Balconies — Superior Airflow, Cross-Ventilation & Flexible Outdoor Living',
    icon: <Shield {...highlightIconProps} />,
  },
  {
    text: 'Minutes from Manyata Tech Park & Airport Road',
    icon: <Navigation {...highlightIconProps} />,
  },
  {
    text: 'World-Class Amenities by Puravankara Limited',
