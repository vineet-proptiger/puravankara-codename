...
const PREVIEW_TEXT = `Puravankara in Hennur enjoys a prime address that is literally a stone's throw away from the Outer Ring Road, ensuring seamless connectivity to key business hubs, IT parks, international schools, healthcare centres & lifestyle destinations. Puravankara Codename Hennur is an upcoming premium residential project by the reputed Puravankara Developer Group, ideally located in Hennur, Bangalore.`

const MORE_TEXT = ` Designed for those who value comfort and style, the project offers well-planned 3 & 4 BHK Apartments that combine modern architecture with a touch of elegance. Each home at Puravankara Codename Hennur is thoughtfully crafted to provide natural light, ventilation, and space, creating a perfect balance between peaceful living and urban convenience.`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="Puravankara Codename Hennur" fill className="object-cover object-top"
