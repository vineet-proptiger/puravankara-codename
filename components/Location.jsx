...
const locationCategories = [
  {
    ...
    items: [
      { name: 'Outer Ring Road (ORR)', time: '3 - 4 Km*' },
      { name: 'MG Road / CBD', time: '8.7 Km*' },
      { name: 'Indiranagar', time: '12 Km*' },
      { name: 'Kempegowda International Airport', time: '24.8 Km*' },
    ],
  },
  {
    title: 'Education Hub',
    ...
    items: [
      { name: 'Legacy School', time: '4.4 Km*' },
      { name: 'Mount Carmel College', time: '8.6 Km*' },
      { name: 'REVA University', time: '11.3 Km*' },
      { name: 'MS Ramaiah Institute of Technology', time: '13.5 Km*' },
    ],
  },
  {
    title: 'Healthcare',
    ...
    items: [
      { name: 'Sparsh Hospital', time: '1.5 Km*' },
      { name: 'Motherhood Hospital', time: '2.9 Km*' },
      { name: 'Cloudnine Hospital', time: '3.2 Km*' },
      { name: 'Aster CMI Hospital', time: '7.8 Km*' },
    ],
  },
  {
    ...
    items: [
      { name: 'Elements Mall, Nagawara', time: '6 Km*' },
      { name: 'Lulu Mall, Hebbal', time: '9 Km*' },
      { name: 'Orion Mall, Rajajinagar', time: '18 Km*' },
      { name: 'Phoenix Marketcity', time: '22 Km*' },
    ],
  },
]
    ...
    <section id="location" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>Hennur Main Road, North Bangalore</span>
          <h2 style={{
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.060808765162!2d77.65!3d13.04!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17950f8b3a6f%3A0x2b5e5e5e5e5e5e5e!2sHennur%20Main%20Road%2C%20Bangalore!5e0!3m2!1sen!2sin!4v1776243828093!5m2!1sen!2sin"
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Hennur Main Road, North Bangalore
                </span>
              </div>
            </div>
          </div>
